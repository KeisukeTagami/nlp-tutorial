...
auto main() -> int {
  ...
  std::vector<std::string> sentences { "Lorem ipsum dolor sit amet consectetur adipisicing elit "
                                       "sed do eiusmod tempor incididunt ut labore et dolore magna "
                                       "aliqua Ut enim ad minim veniam quis nostrud exercitation" };

  auto dataset = torch::data::datasets::NLP(sentences);
  const int64_t batch_size = static_cast<int64_t>(dataset.size().value());
